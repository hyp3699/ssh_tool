...
echo "-------------------------------------------------------------------"
echo -e "${green} 1. 本机信息                   6. Docker管理 ▶${re}"
echo -e "${green} 2. 系统更新                   7. WARP管理 ▶${re}"
echo -e "${green} 3. 系统清理                   "
echo -e "${green} 5. BBR管理                 8. LDNMP建站 ▶${re}"
echo "-------------------------------------------------------------------"
echo -e "${green} 9. 面板工具 ▶                13. 测试脚本合集 ▶${re}"
echo -e "${green}10. 系统工具 ▶                "
echo -e "${green}11. 我的工作区 ▶              "
echo -e "${purple}12. 节点搭建合集 ▶            "
echo "-------------------------------------------------------------------"
